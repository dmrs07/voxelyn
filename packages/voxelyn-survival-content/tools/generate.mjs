...
import { GENERATION_LAYER_SPECS, MODULE_LAYER_SPECS, PLAYER_LAYER_SPECS } from './player-layers.mjs';
...
const results = [...ENTITY_SPECS, ...PLAYER_LAYER_SPECS, ...MODULE_LAYER_SPECS, ...GENERATION_LAYER_SPECS].map(buildEntity);
