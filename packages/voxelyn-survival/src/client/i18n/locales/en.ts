...
export const EN: Record<keyof typeof PT_BR, string> = {
  ...
  'arena.suture.select': 'Select the Seamstress and start the arena.',
  ...
  'arena.tools.show': 'tools',
  'arena.tools.hide': 'hide tools',
  'arena.setup.title': 'BOSS ARENA',
  'arena.setup.subtitle':
    'Isolated playtest tool: pick the boss and the entry conditions and fight it yourself. The whole sector (terrain, trash, sites) is what a normal run would generate; only the descent to it is skipped.',
  'arena.setup.locale': 'Language',
  'arena.setup.boss': 'Boss',
  'arena.setup.hp': 'Prospector max HP',
  'arena.setup.ability': 'Echo (equipped ability)',
  'arena.setup.modules': 'Active modules',
  'arena.setup.matrix': 'Generational Matrix',
  'arena.setup.stabilisers': 'Gyroscopic Stabilisers (MV-04)',
  'arena.setup.stabilisersHint':
    'Without the upgrade the Prospector slides ~2.5 tiles on ice; with it, ~1.0, and recovers heading four times faster. It does not protect against cracks: what it buys is the route precision to avoid the critical cell.',
  'arena.setup.coop': 'Presentation co-op',
  'arena.setup.coopPartner': 'Second Prospector, standing still (slot 1)',
  'arena.setup.coopHint':
    'Nobody controls it: it exists to show the partner freezing, with frost, statue and both meters at different levels.',
  'arena.setup.enter': 'Enter the arena',
  'arena.end.victory': 'Boss defeated',
  'arena.end.defeat': 'The Prospector fell',
  'arena.end.abandoned': 'Fight abandoned',
  'arena.end.ticks': '{ticks} ticks simulated',
  'arena.end.cause': 'Cause: {cause}',
  'arena.end.noCause': 'none',
  'arena.end.damageDealt': 'Damage dealt: {value}',
  'arena.end.damageTaken': 'Damage taken: {value}',
  'arena.end.shots': 'Shots fired: {value}',
  'arena.end.retry': 'Try again (same conditions)',
  'arena.end.reconfigure': 'Change setup',
  'toast.boss.awake': '{name} AWOKE',
  // ---------------------------------------------------------------------
  // Brand and menus
  // ---------------------------------------------------------------------
  ...
  'bestiary.name.seamstress_brood': 'Seamstress Brood',
  'bestiary.code.seamstress_brood': 'SPECIMEN SUT-03',
  'bestiary.note.seamstress_brood':
    'Hatches from the Seamstress. Crouches, marks its landing and jumps. Leave the mark and punish its recovery.',
  ...
  'enemy.seamstress': 'The Seamstress',
  'bestiary.name.stitcher': 'Stitcher',
  'bestiary.name.seamstress': 'The Seamstress',
  ...
  'bestiary.name.sheet_leviathan': 'Groundwater Leviathan',
