...
export const DE: Record<keyof typeof PT_BR, string> = {
  ...
  'arena.suture.select': 'Die Stopferin auswählen und die Arena starten.',
  ...
  'enemy.seamstress_brood': 'Brut der Stopferin',
  ...
  'bestiary.name.seamstress_brood': 'Brut der Stopferin',
  'bestiary.code.seamstress_brood': 'EXEMPLAR SUT-03',
  'bestiary.note.seamstress_brood':
    'Schlüpft aus dem Hinterleib der Stopferin. Duckt sich, markiert den Landepunkt und springt. Die Markierung verlassen und während der Erholung angreifen.',
  ...
  'enemy.seamstress': 'Die Stopferin',
  'bestiary.name.stitcher': 'Näher',
  'bestiary.name.seamstress': 'Die Stopferin',
